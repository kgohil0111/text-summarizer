      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <p className="text-gray-600 mt-2">
            Transform your text with AI-powered summarization (Hugging Face
            Inference API Call)
          </p>
        </div>
      </header>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Copy and paste the text you want to summarize into the input
                area
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Press the summarize button to generate an AI-powered summary
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Copy the generated summary and use it wherever you need
              </p>
            </div>
          </div>
        </div>
